    ...
    for i, unique_pattern_length in enumerate(unique_pattern_lengths):
        if unique_pattern_length == 6:
            if decoded_patterns[1][0] in unique_patterns[i] and decoded_patterns[1][1] in unique_patterns[i]:
                if decoded_patterns[4][0] in unique_patterns[i] and decoded_patterns[4][1] in unique_patterns[i] and decoded_patterns[4][2] in unique_patterns[i] and decoded_patterns[4][3] in unique_patterns[i]:
            ...
            if decoded_patterns[1][0] in unique_patterns[i] and decoded_patterns[1][1] in unique_patterns[i]:
                ...
                if eight_minus_four[0] in unique_patterns[i] and eight_minus_four[1] in unique_patterns[i] and eight_minus_four[2] in unique_patterns[i]:
